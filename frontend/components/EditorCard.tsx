...
export default function EditorCard({ ilha }: Props) {
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-950 p-5 shadow-lg shadow-black/20">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-white">{ilha.editor}</h3>
      ...
      <div className="mt-5 rounded-xl bg-slate-900/70 p-4">
        ...
        <p className="mt-2 text-sm font-medium text-white">{ilha.projeto}</p>
      </div>
